...
(function iconSystem() {
  ...
  const I = {
    ...
    move: '<path d="M8 1.8v12.4M1.8 8h12.4"/><path d="M8 1.8L6 3.8M8 1.8l2 2M8 14.2l-2-2M8 14.2l2-2M1.8 8l2-2M1.8 8l2 2M14.2 8l-2-2M14.2 8l-2 2"/>',
    image: '<rect x="2" y="3" width="12" height="10" rx="1.5"/><circle cx="5.6" cy="6.4" r="1.1"/><path d="M2.6 11.4l3.2-3 2.4 2.2 2.2-2 3 2.8"/>',
    triangle: '<path d="M8 2.6l5.6 10.8H2.4z"/>',
    ortho: '<rect x="2.5" y="4.5" width="8" height="8" rx=".8"/><path d="M5.5 4.5l3-2.7h5v5l-3 2.7M10.5 4.5l3-2.7M10.5 12.5l3-2.7"/>',
    grid: '<path d="M2 6h12M2 10h12M6 2v12M10 2v12"/><rect x="2" y="2" width="12" height="12" rx="1"/>',
    section: '<path d="M2.5 10.5l5-8h6l-5 8z"/><path d="M1.5 12.5h13" stroke-dasharray="2 1.6"/>',
    isolate: '<circle cx="8" cy="8" r="2.6"/><circle cx="8" cy="8" r="5.8" stroke-dasharray="2 2"/>',
    explode: '<path d="M8 7V2.5M8 9v4.5M7 8H2.5M9 8h4.5"/><rect x="6.4" y="6.4" width="3.2" height="3.2" rx=".6"/>',
    sidebar: '<rect x="2" y="3" width="12" height="10" rx="1.5"/><path d="M10.5 3v10"/>',
