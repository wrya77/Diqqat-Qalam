...
(function helpCenter() {
  ...
  function cad3dHelp() {
    sheet('دليل مساحة ثلاثيّ الأبعاد', `
      ...
      <h4>الحوافّ والانتقاء الدقيق</h4>
      <p><kbd>Tab</kbd> يُبدّل مستوى الانتقاء: <b>جسم ← وجه ← حافّة ← رأس</b>.
         في المستويات الثلاثة الأخيرة تنتقي جزءاً بعينه بالنقر، و<kbd>Ctrl</kbd>
         يضيف إلى المنتقى. شريط المعلومات يعرض قياس ما انتقيتَه فوراً:
         مساحة الوجه، طول الحافّة وزاويتها، الزاوية بين وجهين، المسافة بين رأسين.</p>
      ${rows([
        ['تدوير الحوافّ', 'قوسٌ بنصف قطرٍ محدَّد — على المنتقى وحده إن كان ثمّة انتقاء، وإلّا على كلّ حافّةٍ حادّة'],
        ['شطف الحوافّ', 'سطحٌ مستوٍ بدل القوس — نفس المنطق في الانتقاء'],
        ['زاوية السحب', 'تمييل الجدران درجاتٍ عن محور السحب: شرطُ إخراج القطعة من قالب، ويخفّف احتكاك الأداة'],
        ['فحص التداخل', 'حدّد جسمين فأكثر — يُعطي حجم تقاطعهما بالسم³ إن تداخلا'],
      ])}
      <p class="dqh-warn">إن خرجت الشبكة غير مغلقة بعد التدوير (يحدث عند رؤوسٍ
         تلتقي فيها حوافُّ كثيرة كقمّة المخروط) فالبرنامج <b>يُخبرك بذلك صراحةً</b>
         بدل أن يُمرّر مجسّماً معطوباً — جرّب الشطف أو نصف قطرٍ أصغر.</p>
      ...
      ${rows([
        ...
        ['<kbd>Tab</kbd>', 'مستوى الانتقاء: جسم ← وجه ← حافّة ← رأس'],
        ['<kbd>+</kbd> · <kbd>−</kbd>', 'تكبير · تصغير (و«تأطير» يملأ الشاشة بالمحدَّد)'],
        ['<kbd>Esc</kbd>', 'إفلاتٌ متدرّج: يغلق القوائم، ثمّ يعود لمستوى الجسم، ثمّ يُلغي التحديد'],
      ])}
