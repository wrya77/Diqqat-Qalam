...
(function cad3dBuild() {
   ...
   * و٩٦ ضلعاً. الأربعون ضلعاً الثابتة كانت تُظهر الدائرة مضلّعاً مقصوصاً.
   *
   * خطأ الوتر ٠٫٠٦مم لا ٠٫٠٢: الفرق بينهما غير مرئيّ على الشاشة (كلاهما دون
   * سُمك البكسل عند أي تكبير معقول) لكنّه ثلاثة أضعاف المثلّثات — وتكلفة الـCSG
   * تنمو أسرع من خطّياً معها، فكانت الكرة الواحدة تُكلّف أربع ثوانٍ في الطرح.
